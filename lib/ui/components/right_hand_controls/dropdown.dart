...
/// [DropDown] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [DropDown].
///
/// {@tool dartpad}
/// This example demonstrates different configurations of DropDown.
///
...
class DropDown extends StatefulWidget {
  ...
  /// the tile to reveal or hide the [children]. The [isExpanded] property must
  /// be non-null.
  const DropDown({
    Key? key,
    this.leading,
  ...
  State<DropDown> createState() => DropDownState(onTap: onTap);
}

class DropDownState extends State<DropDown>
    with SingleTickerProviderStateMixin {
  final Function onTap;
  DropDownState({required this.onTap});
